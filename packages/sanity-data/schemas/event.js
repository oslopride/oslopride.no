export default {
  ...
  fields: [
    ...
    {
      name: 'category', // Sjekk om det er en dropdown-ting
      title: 'Programkategori',
  	  type: 'string',
  	  validation: Rule => Rule.required(),
  	  options: {
      list: [
		"Youngstorget", "Pride Park", "Rockefeller", "Andre"
      ]}
    },
	{
      name: 'eventType', // Sjekk om det er en dropdown-ting
      title: 'Arrangmentstype',
  	  type: 'string',
  	  validation: Rule => Rule.required(),
  	  options: {
      list: [
		"Konsert", "Debatt", "Utstilling", "Annet"
      ]}
    },
    {
      name: 'venue',
